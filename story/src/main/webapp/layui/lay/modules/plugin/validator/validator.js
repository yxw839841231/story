layui.define('jquery', function (exports) {
    ...
    var $ = layui.jquery,
        ...
        fieldDefaults = {
            ...
            msgWrapper: 'span',
            msgArrow: '',
            msgIcon: '<span class="n-icon"><i class="layui-icon n-msg">&#xe69c;</i>&nbsp;</span>',
            msgClass: 'n-right',
            msgStyle: '',
            msgShow: null,
            msgHide: null
    ...
    Validator.prototype = {
        _init: function (element, options) {
            ...
            me.rules = new Rules(Validator.rules, true);
            me.messages = new Messages(Validator.messages, true);
    ...
    new Rules({
        ...
        phone: function () {
            var re = '^1\d{10}$';
            return new RegExp(re).test(this.value) || "手机号格式不正确";
        },
        identify: function () {
    ...
    Validator.load = function (str) {
        ...
        if (!Validator.css && params.css !== '') {
            ...
            el.rel = 'stylesheet';
            el.href = Validator.css = dir + 'validator.css';
