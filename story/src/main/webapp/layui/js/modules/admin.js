        ...
        $.ajax({
            ...
            success: function (d) {
                ...
                if (d.code == 0) {
                    ...
                    var n = 0;
                    layui.each(d.data.system, function(index, data){
                    ...
                    //菜单
                    layui.each(d.data.menu, function(index, data){
                    ...
                    $(".top-menu-bar").bind('click',function () {
                        ...
                        layui.each(treeviewData, function(index, data){
                        ...
                        layui.each(treeviewMenuData, function(index, data){
