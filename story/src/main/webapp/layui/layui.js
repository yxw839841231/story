...
;!function (win) {
    ...
    var doc = document, config = {
        ...
        , modules = {
            ...
            , BJUIfrag: 'modules/plugin/bjui/bjui-frag'
            , BJUIextends: 'modules/plugin/bjui/bjui-extends'
            , BJUIbasedrag: 'modules/plugin/bjui/bjui-basedrag'
            , BJUInavtab: 'modules/plugin/bjui/bjui-navtab'
            , BJUIajax: 'modules/plugin/bjui/bjui-ajax'
            , BJUIpagination: 'modules/plugin/bjui/bjui-pagination'
            ...
            ,ZJOINselect:'modules/plugin/zjoin/bootstrap-select'
            ,ZJOINboxrefresh:'modules/plugin/zjoin/zjoin-boxrefresh'
            ,ZJOINwidget:'modules/plugin/zjoin/zjoin-widget'
            ,ZJOINsidebar:'modules/plugin/zjoin/zjoin-sidebar'
            ,ZJOINlayout:'modules/plugin/zjoin/zjoin-layout'
            ,ZJOINpushmenu:'modules/plugin/zjoin/zjoin-pushmenu'
